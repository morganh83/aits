# Generated by Django 3.2.7 on 2023-12-30 21:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ticketLink', models.CharField(blank=True, default='', max_length=500, null=True)),
                ('courtesy', models.BooleanField(blank=True, default=False)),
                ('counterLink', models.CharField(blank=True, default='', max_length=500, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discName', models.CharField(blank=True, default='', max_length=100, null=True)),
                ('steamId', models.IntegerField(blank=True, default=0, null=True)),
                ('growth', models.CharField(blank=True, default='', max_length=6, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clarity', models.TextField(blank=True, default='', max_length=2000)),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='brokenRules', to='app.punishticket')),
            ],
        ),
    ]
